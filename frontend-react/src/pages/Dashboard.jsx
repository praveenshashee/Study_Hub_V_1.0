...
import VideoShelfSection from "../components/VideoShelfSection.jsx";
import {
  getPopularVideos,
  getPreferredSubject,
...
function Dashboard() {
  ...
  useEffect(() => {
    const loadDashboardData = async () => {
      ...
      const [videosResult, internshipsResult] = await Promise.allSettled([
        api.get("/api/videos"),
  ...
  if (loading) {
    return (
      <div className="dashboard-page">
        <p className="page-message">Loading your dashboard...</p>
      </div>
    );
  }
    ...
    <div className="dashboard-page">
      <div className="dashboard-hero">
        <div className="dashboard-hero-copy">
          <span className="dashboard-eyebrow">Personalized learning space</span>
          <h1>Your StudyHub Dashboard</h1>
          <p>
            Track your study rhythm, surface the strongest learning signals,
            and keep an eye on internship deadlines from one place.
          </p>
        ...
        <aside className="dashboard-hero-panel">
          ...
          <div className="dashboard-panel-grid">
            ...
            <div className="dashboard-panel-item">
              ...
              <p>{nextDeadline ? nextDeadline.title : "Internship board is clear for now"}</p>
            </div>
      ...
      <div className="dashboard-stats-grid">
        <article className="dashboard-stat-card">
          ...
          <p>Your personal shortlist for revision and quick return access.</p>
        </article>

        <article className="dashboard-stat-card">
          <span className="dashboard-stat-label">Continue watching</span>
          <strong className="dashboard-stat-value">{recentVideos.length}</strong>
          <p>Resume your last study sessions without searching again.</p>
        </article>
        ...
        <article className="dashboard-stat-card">
          ...
          <p>Fresh picks based on your current learning behavior.</p>
        </article>
        ...
        <article className="dashboard-stat-card">
          ...
          <p>Live opportunities connected to the broader study platform.</p>
        </article>
